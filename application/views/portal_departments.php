                    ...
                    <div class="row mt-3">
                        <div class="col-sm-12">
                            <div class="page-title-box d-flex justify-content-between align-items-center">
                                <div>
                                    <h4 class="page-title mb-0">Departments</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="card-box">
                                ...
                                <form action="<?= site_url('portal/departments'); ?>" method="post">
                                    ...
                                    <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                            <?php if (!empty($departments)): ?>
                                                ...
                                                <?php endforeach; ?>
                                            <?php else: ?>
                                                <tr><td colspan="2" class="text-muted text-center">No departments yet.</td></tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
                                </div>
