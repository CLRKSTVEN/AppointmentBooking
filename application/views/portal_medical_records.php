                    ...
                    <div class="row mt-3">
                        <div class="col-sm-12">
                            <div class="page-title-box d-flex justify-content-between align-items-center">
                                <div>
                                    <h4 class="page-title mb-0">Medical Records</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card-box">
                                ...
                                <form action="<?= site_url('portal/medical-records'); ?>" method="post">
                        ...
                        <div class="col-lg-8">
                            <div class="card-box">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <form method="get" action="<?= site_url('portal/medical-records'); ?>" class="form-inline">
                                    ...
                                    <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                            <?php if (!empty($records)): ?>
                                                ...
                                                <?php endforeach; ?>
                                            <?php else: ?>
                                                <tr><td colspan="3" class="text-muted text-center">No records yet.</td></tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
                                </div>
